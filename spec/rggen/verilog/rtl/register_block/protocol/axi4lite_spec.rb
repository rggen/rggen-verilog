...
RSpec.describe 'register_block/protocol/axi4lite' do
  ...
  it 'AXI4LITE用のポート群を持つ' do
    ...
    expect(register_block).to have_port(
      :awid,
      name: 'i_awid', direction: :input, width: '`rggen_clip_width(ID_WIDTH)'
    )
    expect(register_block).to have_port(
      :awaddr,
    ...
    expect(register_block).to have_port(
      :bid,
      name: 'o_bid', direction: :output, width: '`rggen_clip_width(ID_WIDTH)'
    )
    expect(register_block).to have_port(
      :bresp,
    ...
    expect(register_block).to have_port(
      :arid,
      name: 'i_arid', direction: :input, width: '`rggen_clip_width(ID_WIDTH)'
    )
    expect(register_block).to have_port(
      :araddr,
    ...
    expect(register_block).to have_port(
      :rid,
      name: 'o_rid', direction: :output, width: '`rggen_clip_width(ID_WIDTH)'
    )
    expect(register_block).to have_port(
      :rdata,
