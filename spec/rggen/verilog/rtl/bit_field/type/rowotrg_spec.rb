...
RSpec.describe 'bit_field/type/rowotrg' do
  ...
  it '出力ポート#value_out/#write_trigger/#read_triggerを持つ' do
    ...
    expect(bit_fields[0]).to have_port(
      ...
      name: 'o_register_0_bit_field_0_write_trigger', direction: :output, width: 1
    )
    expect(bit_fields[0]).to have_port(
    ...
    expect(bit_fields[1]).to have_port(
      :register_block, :write_trigger,
      name: 'o_register_0_bit_field_1_write_trigger', direction: :output, width: 1
    )
    expect(bit_fields[1]).to have_port(
      :register_block, :read_trigger,
    ...
    expect(bit_fields[2]).to have_port(
      :register_block, :write_trigger,
      name: 'o_register_0_bit_field_2_write_trigger', direction: :output, width: 1, array_size: [2]
    )
    expect(bit_fields[2]).to have_port(
      :register_block, :read_trigger,
    ...
    expect(bit_fields[3]).to have_port(
      :register_block, :write_trigger,
      name: 'o_register_1_bit_field_0_write_trigger', direction: :output, width: 1
    )
    expect(bit_fields[3]).to have_port(
      :register_block, :read_trigger,
    ...
    expect(bit_fields[4]).to have_port(
      :register_block, :write_trigger,
      name: 'o_register_2_bit_field_0_write_trigger', direction: :output, width: 1, array_size: [4]
    )
    expect(bit_fields[4]).to have_port(
      :register_block, :read_trigger,
    ...
    expect(bit_fields[5]).to have_port(
      :register_block, :write_trigger,
      name: 'o_register_2_bit_field_1_write_trigger', direction: :output, width: 1, array_size: [4]
    )
    expect(bit_fields[5]).to have_port(
      :register_block, :read_trigger,
    ...
    expect(bit_fields[6]).to have_port(
      :register_block, :write_trigger,
      name: 'o_register_2_bit_field_2_write_trigger', direction: :output, width: 1, array_size: [4, 2]
    )
    expect(bit_fields[6]).to have_port(
      :register_block, :read_trigger,
    ...
    expect(bit_fields[7]).to have_port(
      :register_block, :write_trigger,
      name: 'o_register_3_bit_field_0_write_trigger', direction: :output, width: 1, array_size: [2, 2]
    )
    expect(bit_fields[7]).to have_port(
      :register_block, :read_trigger,
    ...
    expect(bit_fields[8]).to have_port(
      :register_block, :write_trigger,
      name: 'o_register_3_bit_field_1_write_trigger', direction: :output, width: 1, array_size: [2, 2]
    )
    expect(bit_fields[8]).to have_port(
      :register_block, :read_trigger,
    ...
    expect(bit_fields[9]).to have_port(
      :register_block, :write_trigger,
      name: 'o_register_3_bit_field_2_write_trigger', direction: :output, width: 1, array_size: [2, 2, 2]
    )
    expect(bit_fields[9]).to have_port(
      :register_block, :read_trigger,
    ...
    expect(bit_fields[10]).to have_port(
      :register_block, :write_trigger,
      name: 'o_register_file_4_register_file_0_register_0_bit_field_0_write_trigger', direction: :output, width: 1, array_size: [2, 2, 2, 2]
    )
    expect(bit_fields[10]).to have_port(
      :register_block, :read_trigger,
    ...
    expect(bit_fields[11]).to have_port(
      :register_block, :write_trigger,
      name: 'o_register_file_4_register_file_0_register_0_bit_field_1_write_trigger', direction: :output, width: 1, array_size: [2, 2, 2, 2]
    )
    expect(bit_fields[11]).to have_port(
      :register_block, :read_trigger,
    ...
    expect(bit_fields[12]).to have_port(
      :register_block, :write_trigger,
      name: 'o_register_file_4_register_file_0_register_0_bit_field_2_write_trigger', direction: :output, width: 1, array_size: [2, 2, 2, 2, 2]
    )
    expect(bit_fields[12]).to have_port(
      :register_block, :read_trigger,
    ...
    it 'rggen_bit_fieldをインスタンスするコードを生成する' do
      ...
      expect(bit_fields[7]).to generate_code(:bit_field, :top_down, <<~'CODE')
        rggen_bit_field #(
          ...
          .o_write_trigger    (o_register_3_bit_field_0_write_trigger[1*(i)+:1]),
          ...
          .i_mask             ({4{1'b1}}),
          .o_value            (o_register_3_bit_field_0[4*(i)+:4]),
          .o_value_unmasked   ()
        );
      CODE
      ...
      expect(bit_fields[8]).to generate_code(:bit_field, :top_down, <<~'CODE')
        rggen_bit_field #(
          ...
          .o_write_trigger    (o_register_3_bit_field_1_write_trigger[1*(i)+:1]),
          ...
          .i_mask             ({4{1'b1}}),
          .o_value            (o_register_3_bit_field_1[4*(i)+:4]),
          .o_value_unmasked   ()
        );
      CODE
      ...
      expect(bit_fields[9]).to generate_code(:bit_field, :top_down, <<~'CODE')
        rggen_bit_field #(
          ...
          .o_write_trigger    (o_register_3_bit_field_2_write_trigger[1*(i)+:1]),
          ...
          .i_mask             ({4{1'b1}}),
          .o_value            (o_register_3_bit_field_2[4*(i)+:4]),
          .o_value_unmasked   ()
        );
      CODE
      ...
      expect(bit_fields[12]).to generate_code(:bit_field, :top_down, <<~'CODE')
        rggen_bit_field #(
          ...
          .o_write_trigger    (o_register_5_bit_field_0_write_trigger[1*(2*i+j)+:1]),
          ...
          .i_mask             ({4{1'b1}}),
          .o_value            (o_register_5_bit_field_0[4*(2*i+j)+:4]),
          .o_value_unmasked   ()
        );
      CODE
      ...
      expect(bit_fields[13]).to generate_code(:bit_field, :top_down, <<~'CODE')
        rggen_bit_field #(
          ...
          .o_write_trigger    (o_register_5_bit_field_1_write_trigger[1*(2*i+j)+:1]),
          ...
          .i_mask             ({4{1'b1}}),
          .o_value            (o_register_5_bit_field_1[4*(2*i+j)+:4]),
          .o_value_unmasked   ()
        );
      CODE
      ...
      expect(bit_fields[14]).to generate_code(:bit_field, :top_down, <<~'CODE')
        rggen_bit_field #(
          ...
          .o_write_trigger    (o_register_5_bit_field_2_write_trigger[1*(2*i+j)+:1]),
          ...
          .i_mask             ({4{1'b1}}),
          .o_value            (o_register_5_bit_field_2[4*(2*i+j)+:4]),
          .o_value_unmasked   ()
        );
      CODE
      ...
      expect(bit_fields[17]).to generate_code(:bit_field, :top_down, <<~'CODE')
        rggen_bit_field #(
          ...
          .o_write_trigger    (o_register_8_bit_field_0_write_trigger[1*(4*i+2*j+k)+:1]),
          ...
          .i_mask             ({4{1'b1}}),
          .o_value            (o_register_8_bit_field_0[4*(4*i+2*j+k)+:4]),
          .o_value_unmasked   ()
        );
      CODE
      ...
      expect(bit_fields[18]).to generate_code(:bit_field, :top_down, <<~'CODE')
        rggen_bit_field #(
          ...
          .o_write_trigger    (o_register_8_bit_field_1_write_trigger[1*(4*i+2*j+k)+:1]),
          ...
          .i_mask             ({4{1'b1}}),
          .o_value            (o_register_8_bit_field_1[4*(4*i+2*j+k)+:4]),
          .o_value_unmasked   ()
        );
      CODE
      ...
      expect(bit_fields[19]).to generate_code(:bit_field, :top_down, <<~'CODE')
        rggen_bit_field #(
          ...
          .o_write_trigger    (o_register_8_bit_field_2_write_trigger[1*(4*i+2*j+k)+:1]),
          ...
          .i_mask             ({4{1'b1}}),
          .o_value            (o_register_8_bit_field_2[4*(4*i+2*j+k)+:4]),
          .o_value_unmasked   ()
        );
      CODE
      ...
      expect(bit_fields[22]).to generate_code(:bit_field, :top_down, <<~'CODE')
        rggen_bit_field #(
          ...
          .o_write_trigger    (o_register_file_11_register_file_0_register_0_bit_field_0_write_trigger[1*(16*i+8*j+4*k+2*l+m)+:1]),
          ...
          .i_mask             ({4{1'b1}}),
          .o_value            (o_register_file_11_register_file_0_register_0_bit_field_0[4*(16*i+8*j+4*k+2*l+m)+:4]),
          .o_value_unmasked   ()
        );
      CODE
      ...
      expect(bit_fields[23]).to generate_code(:bit_field, :top_down, <<~'CODE')
        rggen_bit_field #(
          ...
          .o_write_trigger    (o_register_file_11_register_file_0_register_0_bit_field_1_write_trigger[1*(16*i+8*j+4*k+2*l+m)+:1]),
          ...
          .i_mask             ({4{1'b1}}),
          .o_value            (o_register_file_11_register_file_0_register_0_bit_field_1[4*(16*i+8*j+4*k+2*l+m)+:4]),
          .o_value_unmasked   ()
        );
      CODE
      ...
      expect(bit_fields[24]).to generate_code(:bit_field, :top_down, <<~'CODE')
        rggen_bit_field #(
          ...
          .o_write_trigger    (o_register_file_11_register_file_0_register_0_bit_field_2_write_trigger[1*(16*i+8*j+4*k+2*l+m)+:1]),
          ...
          .i_mask             ({4{1'b1}}),
          .o_value            (o_register_file_11_register_file_0_register_0_bit_field_2[4*(16*i+8*j+4*k+2*l+m)+:4]),
          .o_value_unmasked   ()
        );
      CODE
    end
