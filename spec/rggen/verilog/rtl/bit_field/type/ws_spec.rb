...
RSpec.describe 'bit_field/type/ws' do
  ...
  it '出力ポート#value_out/入力ポート#clearを持つ' do
    ...
    expect(bit_fields[1]).to have_port(
      :register_block, :clear,
      name: 'i_register_0_bit_field_1_clear', direction: :input, width: 2
    )
    ...
    expect(bit_fields[2]).to have_port(
      :register_block, :clear,
      name: 'i_register_0_bit_field_2_clear', direction: :input, width: 4, array_size: [2]
    )
    ...
    expect(bit_fields[3]).to have_port(
      :register_block, :clear,
      name: 'i_register_1_bit_field_0_clear', direction: :input, width: 64
    )
    ...
    expect(bit_fields[4]).to have_port(
      :register_block, :clear,
      name: 'i_register_2_bit_field_0_clear', direction: :input, width: 1, array_size: [4]
    )
    ...
    expect(bit_fields[5]).to have_port(
      :register_block, :clear,
      name: 'i_register_2_bit_field_1_clear', direction: :input, width: 2, array_size: [4]
    )
    ...
    expect(bit_fields[6]).to have_port(
      :register_block, :clear,
      name: 'i_register_2_bit_field_2_clear', direction: :input, width: 4, array_size: [4, 2]
    )
    ...
    expect(bit_fields[7]).to have_port(
      :register_block, :clear,
      name: 'i_register_3_bit_field_0_clear', direction: :input, width: 1, array_size: [2, 2]
    )
    ...
    expect(bit_fields[8]).to have_port(
      :register_block, :clear,
      name: 'i_register_3_bit_field_1_clear', direction: :input, width: 2, array_size: [2, 2]
    )
    ...
    expect(bit_fields[9]).to have_port(
      :register_block, :clear,
      name: 'i_register_3_bit_field_2_clear', direction: :input, width: 4, array_size: [2, 2, 2]
    )
    ...
    expect(bit_fields[10]).to have_port(
      :register_block, :clear,
      name: 'i_register_file_4_register_file_0_register_0_bit_field_0_clear', direction: :input, width: 1, array_size: [2, 2, 2, 2]
    )
    ...
    expect(bit_fields[11]).to have_port(
      :register_block, :clear,
      name: 'i_register_file_4_register_file_0_register_0_bit_field_1_clear', direction: :input, width: 2, array_size: [2, 2, 2, 2]
    )
    ...
    expect(bit_fields[12]).to have_port(
      :register_block, :clear,
      name: 'i_register_file_4_register_file_0_register_0_bit_field_2_clear', direction: :input, width: 4, array_size: [2, 2, 2, 2, 2]
    )
  end
    ...
    it 'rggen_bit_fieldをインスタンスするコードを出力する' do
      ...
      expect(bit_fields[3]).to generate_code(:bit_field, :top_down, <<~'CODE')
        rggen_bit_field #(
          ...
          .i_hw_set           ({4{1'b0}}),
          .i_hw_clear         (i_register_2_bit_field_0_clear[4*(i)+:4]),
          .i_value            ({4{1'b0}}),
          .i_mask             ({4{1'b1}}),
      ...
      expect(bit_fields[4]).to generate_code(:bit_field, :top_down, <<~'CODE')
        rggen_bit_field #(
          ...
          .i_hw_write_data    ({4{1'b0}}),
          .i_hw_set           ({4{1'b0}}),
          .i_hw_clear         (i_register_3_bit_field_0_clear[4*(4*i+j)+:4]),
          .i_value            ({4{1'b0}}),
          .i_mask             ({4{1'b1}}),
      ...
      expect(bit_fields[5]).to generate_code(:bit_field, :top_down, <<~'CODE')
        rggen_bit_field #(
          ...
          .i_hw_write_data    ({4{1'b0}}),
          .i_hw_set           ({4{1'b0}}),
          .i_hw_clear         (i_register_4_bit_field_0_clear[4*(8*i+4*j+k)+:4]),
          .i_value            ({4{1'b0}}),
          .i_mask             ({4{1'b1}}),
      ...
      expect(bit_fields[6]).to generate_code(:bit_field, :top_down, <<~'CODE')
        rggen_bit_field #(
          ...
          .i_hw_write_data    ({4{1'b0}}),
          .i_hw_set           ({4{1'b0}}),
          .i_hw_clear         (i_register_file_5_register_file_0_register_0_bit_field_0_clear[4*(32*i+16*j+8*k+4*l+m)+:4]),
          .i_value            ({4{1'b0}}),
          .i_mask             ({4{1'b1}}),
