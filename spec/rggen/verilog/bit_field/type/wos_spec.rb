    ...
    it 'rggen_bit_field_w01s_wosをインスタンスするコードを出力する' do
      ...
      expect(bit_fields[3]).to generate_code(:bit_field, :top_down, <<~'CODE')
        rggen_bit_field_w01s_ws_wos #(
          ...
          .i_clear                (i_register_2_bit_field_0_clear[4*(i)+:4]),
      ...
      expect(bit_fields[4]).to generate_code(:bit_field, :top_down, <<~'CODE')
        rggen_bit_field_w01s_ws_wos #(
          ...
          .i_clear                (i_register_3_bit_field_0_clear[4*(4*i+j)+:4]),
      ...
      expect(bit_fields[5]).to generate_code(:bit_field, :top_down, <<~'CODE')
        rggen_bit_field_w01s_ws_wos #(
          ...
          .i_clear                (i_register_4_bit_field_0_clear[4*(8*i+4*j+k)+:4]),
      ...
      expect(bit_fields[6]).to generate_code(:bit_field, :top_down, <<~'CODE')
        rggen_bit_field_w01s_ws_wos #(
          ...
          .i_clear                (i_register_file_5_register_file_0_register_0_bit_field_0_clear[4*(32*i+16*j+8*k+4*l+m)+:4]),
