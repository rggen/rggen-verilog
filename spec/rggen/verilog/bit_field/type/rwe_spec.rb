  ...
  context '参照ビットフィールドを持たない場合' do
    it '入力ポート#enableを持つ' do
      expect(bit_fields[0]).to have_port(
        ...
        name: 'i_register_0_bit_field_0_enable', direction: :input, width: 1
      )
      expect(bit_fields[2]).to have_port(
        :register_block, :enable,
        name: 'i_register_0_bit_field_2_enable', direction: :input, width: 1
      )
      expect(bit_fields[4]).to have_port(
        :register_block, :enable,
        name: 'i_register_0_bit_field_4_enable', direction: :input, width: 1, array_size: [2]
      )

      expect(bit_fields[6]).to have_port(
        :register_block, :enable,
        name: 'i_register_1_bit_field_0_enable', direction: :input, width: 1, array_size: [4]
      )
      expect(bit_fields[8]).to have_port(
        :register_block, :enable,
        name: 'i_register_1_bit_field_2_enable', direction: :input, width: 1, array_size: [4]
      )
      expect(bit_fields[10]).to have_port(
        :register_block, :enable,
        name: 'i_register_1_bit_field_4_enable', direction: :input, width: 1, array_size: [4, 2]
      )

      expect(bit_fields[12]).to have_port(
        :register_block, :enable,
        name: 'i_register_2_bit_field_0_enable', direction: :input, width: 1, array_size: [2, 2]
      )
      expect(bit_fields[14]).to have_port(
        :register_block, :enable,
        name: 'i_register_2_bit_field_2_enable', direction: :input, width: 1, array_size: [2, 2]
      )
      expect(bit_fields[16]).to have_port(
        :register_block, :enable,
        name: 'i_register_2_bit_field_4_enable', direction: :input, width: 1, array_size: [2, 2, 2]
      )

      expect(bit_fields[19]).to have_port(
        :register_block, :enable,
        name: 'i_register_file_4_register_file_0_register_0_bit_field_0_enable', direction: :input, width: 1, array_size: [2, 2, 2, 2]
      )
      expect(bit_fields[21]).to have_port(
        :register_block, :enable,
        name: 'i_register_file_4_register_file_0_register_0_bit_field_2_enable', direction: :input, width: 1, array_size: [2, 2, 2, 2]
      )
      expect(bit_fields[23]).to have_port(
        :register_block, :enable,
        name: 'i_register_file_4_register_file_0_register_0_bit_field_4_enable', direction: :input, width: 1, array_size: [2, 2, 2, 2, 2]
      )
    end
  end
  ...
  context '参照ビットフィールドを持つ場合' do
    it '入力ポート#enableを持たない' do
      expect(bit_fields[1]).to not_have_port(
        :register_block, :enable,
        name: 'i_register_0_bit_field_1_enable', direction: :input, width: 1
      )
      expect(bit_fields[3]).to not_have_port(
        :register_block, :enable,
        name: 'i_register_0_bit_field_3_enable', direction: :input, width: 1
      )
      expect(bit_fields[5]).to not_have_port(
        :register_block, :enable,
        name: 'i_register_0_bit_field_5_enable', direction: :input, width: 1, array_size: [2]
      )

      expect(bit_fields[7]).to not_have_port(
        :register_block, :enable,
        name: 'i_register_1_bit_field_1_enable', direction: :input, width: 1, array_size: [4]
      )
      expect(bit_fields[9]).to not_have_port(
        :register_block, :enable,
        name: 'i_register_1_bit_field_3_enable', direction: :input, width: 1, array_size: [4]
      )
      expect(bit_fields[11]).to not_have_port(
        :register_block, :enable,
        name: 'i_register_1_bit_field_5_enable', direction: :input, width: 1, array_size: [4, 2]
      )

      expect(bit_fields[13]).to not_have_port(
        :register_block, :enable,
        name: 'i_register_2_bit_field_1_enable', direction: :input, width: 1, array_size: [2, 2]
      )
      expect(bit_fields[15]).to not_have_port(
        :register_block, :enable,
        name: 'i_register_2_bit_field_3_enable', direction: :input, width: 1, array_size: [2, 2]
      )
      expect(bit_fields[17]).to not_have_port(
        :register_block, :enable,
        name: 'i_register_2_bit_field_5_enable', direction: :input, width: 1, array_size: [2, 2, 2]
      )

      expect(bit_fields[18]).to not_have_port(
        :register_block, :enable,
        name: 'o_register_3_bit_field_0_enable', direction: :input, width: 1
      )

      expect(bit_fields[20]).to not_have_port(
        :register_block, :enable,
        name: 'i_register_file_4_register_file_0_register_0_bit_field_1_enable', direction: :input, width: 1, array_size: [2, 2, 2, 2]
      )
      expect(bit_fields[22]).to not_have_port(
        :register_block, :enable,
        name: 'i_register_file_4_register_file_0_register_0_bit_field_3_enable', direction: :input, width: 1, array_size: [2, 2, 2, 2]
      )
      expect(bit_fields[24]).to not_have_port(
        :register_block, :enable,
        name: 'i_register_file_4_register_file_0_register_0_bit_field_5_enable', direction: :input, width: 1, array_size: [2, 2, 2, 2, 2]
      )
    end
  end
    ...
    it 'rggen_bit_field_rweをインスタンスするコードを出力する' do
      ...
      expect(bit_fields[1]).to generate_code(:bit_field, :top_down, <<~'CODE')
        rggen_bit_field_rwe #(
          ...
          .i_enable               (w_register_value[832+:1]),
      ...
      expect(bit_fields[4]).to generate_code(:bit_field, :top_down, <<~'CODE')
        rggen_bit_field_rwe #(
          ...
          .i_enable               (i_register_0_bit_field_4_enable[1*(i)+:1]),
      ...
      expect(bit_fields[10]).to generate_code(:bit_field, :top_down, <<~'CODE')
        rggen_bit_field_rwe #(
          ...
          .i_enable               (i_register_1_bit_field_4_enable[1*(2*i+j)+:1]),
      ...
      expect(bit_fields[16]).to generate_code(:bit_field, :top_down, <<~'CODE')
        rggen_bit_field_rwe #(
          ...
          .i_enable               (i_register_2_bit_field_4_enable[1*(4*i+2*j+k)+:1]),
      ...
      expect(bit_fields[18]).to generate_code(:bit_field, :top_down, <<~'CODE')
        rggen_bit_field_rwe #(
          ...
          .o_bit_field_read_data  (w_bit_field_read_data[0+:1]),
          .o_bit_field_value      (w_bit_field_value[0+:1]),
          .i_enable               (w_register_value[864+:1]),
      ...
      expect(bit_fields[23]).to generate_code(:bit_field, :top_down, <<~'CODE')
        rggen_bit_field_rwe #(
          ...
          .i_enable               (i_register_file_4_register_file_0_register_0_bit_field_4_enable[1*(16*i+8*j+4*k+2*l+m)+:1]),
      ...
      expect(bit_fields[24]).to generate_code(:bit_field, :top_down, <<~'CODE')
        rggen_bit_field_rwe #(
          ...
          .i_enable               (w_register_value[32*(28+2*i+j)+0+:1]),
